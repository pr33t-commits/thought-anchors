...
parser.add_argument('-m', '--model', type=str, default="deepseek-ai/DeepSeek-R1-Distill-Qwen-14B", help='Model to use') # "deepseek/deepseek-r1-distill-llama-8b" accounts/fireworks/models/deepseek-r1-distill-qwen-14b #deepseek-ai/DeepSeek-R1-Distill-Qwen-14B
...
parser.add_argument('-ncr', '--n_chunks_rollout', type=int, default=None, help='number of chunks to produce rollouts for')
...
parser.add_argument('-p', '--provider', type=str, default="Local", choices=['Novita', 'Together', 'Fireworks', 'OpenRouter','Local'], help='Provider to use') # "Together"
...
if args.provider == "Local":
    try:
        ...
        # Define a safe, space-free cache directory
        safe_cache_path = "C:/hf_cache"
        
        # Load tokenizer
        # local_tokenizer = AutoTokenizer.from_pretrained(model, token=HF_KEY, trust_remote_code=True)
